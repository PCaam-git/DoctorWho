...
<div class="container py-5">
    ...
    <div class="d-flex justify-content-between mb-4">
        ...
        <c:if test="${esAdmin}">
            <a href="${pageContext.request.contextPath}/categorias/editar?id=${categoria.id}" class="btn btn-warning">
            ...
            <div class="row">
                <div class="col-md-8 mx-auto">
                    ...
                    <div class="info-item">
                        ...
                        <p class="ms-4">
                            <span class="badge ${categoria.tieneProductos ? 'bg-success' : 'bg-secondary'} fs-6">
                                <c:choose>
                    ...
                    <div class="info-item">
                        ...
                        <p class="ms-4">
                            <c:choose>
                                <c:when test="${categoria.imagen != null && categoria.imagen != 'default.jpg'}">
                                    <span class="text-info">${categoria.imagen}</span>
                                </c:when>
                                <c:otherwise>
                                    <span class="text-muted">Imagen por defecto</span>
                                </c:otherwise>
                            </c:choose>
                        </p>
                    </div>
    ...
    <div class="text-center mt-4">
        ...
        <a href="${pageContext.request.contextPath}/categorias/lista" 
