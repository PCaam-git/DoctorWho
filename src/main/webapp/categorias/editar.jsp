...
<div class="container">
    <div class="form-container">
        ...
        <form method="post" action="${pageContext.request.contextPath}/categorias/actualizar" id="editarForm">
            ...
            <div class="mb-3">
                ...
                <div class="form-text">Nombre actual: <span class="current-value">${categoria.nombre}</span></div>
            </div>
            ...
            <div class="mb-3">
                ...
                <div class="form-text">Descripción actual: <span class="current-value">${categoria.descripcion}</span></div>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" id="cantidad" name="cantidad" class="form-control" 
                       min="0" value="${categoria.cantidad}" required>
                <div class="form-text">Cantidad actual: <span class="current-value">${categoria.cantidad}</span></div>
            </div>
            ...
            <div class="mb-3">
                ...
                <div class="form-text">
                    Estado actual: 
                    <span class="current-value badge ${categoria.tieneProductos ? 'bg-success' : 'bg-secondary'}">
            ...
            <div class="mb-3">
                ...
                <input type="date" id="fecha_actualizacion" name="fecha_actualizacion" 
                       class="form-control" value="<fmt:formatDate value='${categoria.fechaActualizacion}' pattern='yyyy-MM-dd'/>" required>
                <div class="form-text">
                    Fecha actual: 
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    <input type="number" id="precio_medio" name="precio_medio" 
                           ...
                           value="${categoria.precioMedio != null ? categoria.precioMedio : ''}">
            ...
            <div class="mb-4">
                ...
                <div class="form-text">Imagen actual: <span class="current-value">${categoria.imagen}</span></div>
            </div>
...
<script>
    ...
    document.getElementById('editarForm').addEventListener('submit', function(e) {
        ...
        if (!confirm('¿Confirmas que quieres guardar los cambios en la categoría "${categoria.nombre}"?')) {
            e.preventDefault();
            return false;
        }
    ...
    const campos = ['nombre', 'descripcion', 'cantidad', 'precio_medio', 'imagen'];
    ...
    // Para el checkbox
    const checkboxOriginal = ${categoria.tieneProductos};
    ...
    const fechaOriginal = '<fmt:formatDate value="${categoria.fechaActualizacion}" pattern="yyyy-MM-dd"/>';
